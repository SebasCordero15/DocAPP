  ...
  return (
    <main style={{ minHeight: "100vh", background: "#f1f5f9", fontFamily: `'${company.fontFamily}', Inter, system-ui, sans-serif` }}>
      ...
      <header style={{ background: brand, color: "#fff", padding: "14px 28px", display: "flex", justifyContent: "space-between", alignItems: "center" }}>
        <strong style={{ fontSize: 17 }}>{company.name} · KE-Control</strong>
                  ...
                  return (
                    <tr key={inv.id} style={{ borderBottom: "1px solid #f8fafc" }}>
                      ...
                      <td style={{ padding: "11px 20px", fontSize: 13, color: "#64748b" }}>
                        {new Date(inv.expiresAt).toLocaleDateString('es-CR', { day: '2-digit', month: '2-digit', year: 'numeric' })} {new Date(inv.expiresAt).toLocaleTimeString('es-CR', { hour: "2-digit", minute: "2-digit" })}
                      </td>
                      <td style={{ padding: "11px 20px" }}>
                        <button
